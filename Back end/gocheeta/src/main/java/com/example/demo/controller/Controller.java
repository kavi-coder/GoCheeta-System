...
public class Controller {
	...
	public List<Vehicle> allvehicles() {
		return vehicle_services.allvehicles();
	}
	...
	public List<Driver> alldrivers() {
		return driver_services.alldrivers();
	}
	...
	public String updateDriver(@RequestBody Driver driverData) {
		return driver_services.updateDriver(driverData);
	}
	...
	@GetMapping(value="/allbranchadmins")
	public List<BranchAdmin> allbranchadmins() {
		return branchAdmin_services.allbranchadmins();
	}
	
	@GetMapping(value="/branchadmins/{branch}")
	public List<BranchAdmin> branchadmins(@PathVariable String branch) {
		return branchAdmin_services.branchadmins(branch);
	}
	
	@PostMapping(value = "/addbranchadmin")
	public String addbranchadmin(@RequestBody BranchAdmin admin) {
		return branchAdmin_services.addbranchadmin(admin);
	}
	...
	public Admin getadmin(@PathVariable int id) {
		return admin_services.getadmin(id);
	}
	
	@PutMapping(value="/updateadmin")
	public String updateadmin(@RequestBody Admin admin) {
		return admin_services.updateadmin(admin);
	}
